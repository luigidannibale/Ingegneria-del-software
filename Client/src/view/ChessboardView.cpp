...
ChessboardView::ChessboardView(wxStaticBitmap* chessboard, std::string iconsDir, float moveX, float moveY, bool isWhite,float scal) {
    ...
    pawnImgs[0] = img::GetImageAndScale(iconsDir + "whitePawn.png",scal);
    pawnImgs[1] = img::GetImageAndScale(iconsDir + "blackPawn.png",scal);
    kingImgs[0] = img::GetImageAndScale(iconsDir + "whiteKing.png",scal);
    kingImgs[1] = img::GetImageAndScale(iconsDir + "blackKing.png",scal);
    queenImgs[0] = img::GetImageAndScale(iconsDir + "whiteQueen.png",scal);
    queenImgs[1] = img::GetImageAndScale(iconsDir + "blackQueen.png",scal);
    rookImgs[0] = img::GetImageAndScale(iconsDir + "whiteRook.png",scal);
    rookImgs[1] = img::GetImageAndScale(iconsDir + "blackRook.png",scal);
    bishopImgs[0] = img::GetImageAndScale(iconsDir + "whiteBishop.png",scal);
    bishopImgs[1] = img::GetImageAndScale(iconsDir + "blackBishop.png",scal);
    knightImgs[0] = img::GetImageAndScale(iconsDir + "whiteKnight.png",scal);
    knightImgs[1] = img::GetImageAndScale(iconsDir + "blackKnight.png",scal);
