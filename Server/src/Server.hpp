...
private:
    ...
    // Operations
    void new_game(int duration, int increment, std::string u_id_b, std::string u_id_w);
    void search_opponent(std::string u_id, int duration, int increment, bool quit = false);
    void update_game(int g_id, std::string moves, Esito e, Motivo m);
    void search_game(int g_id);
    void list_games(std::string user_id);
    ...
    void update_user(std::string username, std::string new_username, std::string nome, std::string cognome, int elo);
    void update_userPreference(std::string username, Chessboard_style c_st, Pieces_style p_st);
